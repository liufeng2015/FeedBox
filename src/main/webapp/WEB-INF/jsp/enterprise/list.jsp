...
<div class="row-fluid">
	...
	<!-- 检索  -->
	<form action="<%=basePath%>/enterprise.do" method="post" name="userForm" id="userForm">
	...
	<table id="table_report" class="table table-striped table-bordered table-hover">
		...
		<tr>
			...
			<th class='center'>统一信用代码</th>
			<th class='center'>注册地址</th>
			<th class='center'>注册资本（万元）</th>
		...
		<c:choose>
			<c:when test="${not empty varList}">
				...
				<td class="center">${var.UniformCreditCode}</td>
				<td class="center">${var.RegisteredAddress}</td>
				<td class="center">${var.RegisteredCapital}</td>
				<td style="width: 155px;">
					<a class='btn btn-mini btn-info' title="编辑" onclick="edit('${var.E_ID }')" ><i class='icon-edit'></i></a>
					<a class='btn btn-mini btn-danger' title="删除"  onclick="del('${var.E_ID }')"><i class='icon-trash'></i></a>
				</td>
				</tr>
				</c:forEach>
			</c:when>
