		...
		<div class="row-fluid">
			<div id="zhongxin">
				...
				<form action="<%=basePath%>/trayBoxRelInfo.do" method="post"	name="userForm" id="userForm">
					...
					<table>
						<tr>
							<td><font color="#808080">物料箱编号：</font>
								<div class="input-prepend">
									<input type="text" name="QRCode" value="${pd.QRCode }" placeholder="这里输入物料箱编号" style="width:130px;"/>
								</div>
							</td>
							...
							<c:when test="${not empty varList}">
								<c:forEach items="${varList}" var="var" varStatus="vs">
									<tr>
										...
										<td class='center'>${var.QRCode}</a></td>
						...
						<table style="width: 100%;">
							...
							<tr>
								<td style="vertical-align: top;" class="left">
									...
									<a class="btn btn-small btn-success" onclick="add('${pd.TrayId }','${pd.TrayRFID }');">新增料箱</a>
								</td>
							</tr>
						</table>
					</div>
...
<script type="text/javascript">
	...
	function add(strTrayId,strTrayRFID){
		 ...
		 diag.Drag=true;
		 diag.Title ="新增";
		 diag.URL = '<%=basePath%>boxInfo/toAdd.do?trayId='+strTrayId+'&trayRFID='+strTrayRFID;
		 diag.Width = 600;
		 diag.Height = 500;
