...
<body>
<div class="row-fluid">
	<div id="page-content" class="clearfix span12">
		
		
		<div class="span12">
				<div class="widget-box transparent">
					<div class="widget-header widget-header-flat">
						<h4 class="lighter"><i class="icon-star orange"></i>托盘统计</h4>
					...
					<div class="widget-body">
						 <div class="widget-main padding-5">
							<div id="z1"></div>
							<iframe src="<%=basePath%>/tongJiInfo.do" width="100%" height="80%" style="border: 0" ></iframe>
						</div>
					</div>
				</div>
				</div>
