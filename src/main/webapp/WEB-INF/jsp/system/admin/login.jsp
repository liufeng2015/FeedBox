...
<body background="static/login/images/banner_slide_02.jpg" >
	...
	<div
		...
		<div id="loginbox">
			<form action="" method="post" name="loginForm"
				...
				<div class="form-actions">
					<div style="width:86%;padding-left:8%;">
						...
						<span class="pull-center" style="padding-right:3%;"><a
							href="javascript:quxiao();" class="btn btn-success">取消</a></span> <span
							class="pull-center"><a onclick="severCheck();"
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">  © 2017</span></font>
				</div>
			</div>
		</div>
	</div>
