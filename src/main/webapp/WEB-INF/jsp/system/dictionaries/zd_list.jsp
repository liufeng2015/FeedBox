...
<script type="text/javascript">
	...
	function ref(){
		var flag = false;
			...
			var url = "<%=basePath%>dictionaries/ref.do?guid="+new Date().getTime();
			$.get(url,function(data){
				if("success" == data.result){
					alert("刷新成功");
	...
	<table id="table_report" class="table table-striped table-bordered table-hover">
		...
		<table style="width:100%;">
			<tr>
				...
				<td style="vertical-align:top;width:50px;"><a class="btn btn-small btn-success" onclick="ref();">刷新</a></td>
